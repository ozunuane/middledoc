  ...
  return withAdmin(request, async (req, adminId) => {
    try {
      ...
      const {
        ...
        max_client_emails,
        max_bcc_emails,
        max_request_templates,
        max_bulk_requests,
        feature_teams,
        feature_groups,
        feature_client_assignments,
        feature_whitelabel_logo,
        feature_whitelabel_full,
        feature_api_readonly,
        feature_api_full,
        feature_sso,
        feature_webhooks,
        feature_activity_log,
        feature_custom_fields,
        feature_recurring_requests,
        feature_data_export,
        is_active,
        is_public,
        sort_order,
      ...
      const result = await query(
        `INSERT INTO plans (
          ...
          max_email_reminders_per_month,
          max_client_emails, max_bcc_emails,
          ...
          feature_api_readonly, feature_api_full,
          feature_sso, feature_webhooks, feature_activity_log,
          feature_custom_fields, feature_recurring_requests, feature_data_export,
